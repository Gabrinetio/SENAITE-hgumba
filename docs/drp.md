...
> **Objetivo:** Estabelecer os procedimentos de backup a quente, failover e recuperação de desastres para o ecossistema SENAITE LIS e Middleware H Gu Marabá, garantindo o SLA de 98% e a preservação do banco de dados (RDC 978/2025).
