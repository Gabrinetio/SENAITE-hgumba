...
<configure xmlns="http://namespaces.zope.org/zope"
    ...
    <!-- Endpoint custom @@hgumba-create-ar (bypass @@API/create) -->
    <browser:page
        name="hgumba-create-ar"
        for="*"
        class=".views.create_ar.CreateAnalysisRequestView"
        permission="zope2.View"
        layer="senaite.core.interfaces.ISenaiteCoreLayer" />

    <!-- Endpoint custom @@hgumba-set-remark (bypass @@API/update) -->
    <browser:page
        name="hgumba-set-remark"
        for="*"
        class=".views.create_ar.SetRemarkView"
        permission="zope2.View"
        layer="senaite.core.interfaces.ISenaiteCoreLayer" />
